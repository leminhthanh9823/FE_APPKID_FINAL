...
const useFetchEBook = <T>(endpoint: string, initialParams: FetchParams) => {
  ...
  const fetchData = useCallback(
    async (requestParams: FetchParams) => {
      ...
      const { category_id, ...restParams } = requestParams;
      const finalEndpoint = category_id
